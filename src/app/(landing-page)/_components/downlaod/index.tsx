      ...
      >
        ...
        >
          ...
          <Typography variant="h5" color="text.secondary">
            {`Listen to Text Like Never Before with Google AI-Powered Voices`}
          </Typography>
          <Grid container my={1} spacing={5} alignItems={"center"}>
            <Grid item xs={12} md={7}>
              ...
              <Typography
                ...
                textAlign={"left"}
              >
                {`Looking for a revolutionary way to listen to text? Gemini Reader
                combines the power of Gemini's premium voices with
                ...
                exploring ideas, Gemini Reader lets you enjoy the richness of
                Gemini's AI-powered voices—without any cost! With added
...
>
  ...
  >
    ...
    GET GEMINI READER FOR EDGE
  </Button>
</Box>

              
                <Alert sx={{ mb: 2 }} severity="info">Note: The extension may not work consistently work for you due to a Gemini update. If this is the case for you, then expect it to be resolved in the coming days.</Alert>
              
              <Box textAlign={"left"}>
                <Link
                  variant="subtitle2"
                  href="https://docs.google.com/document/d/12gD4zoQofLRab3XkLA1Mms2JaOq3KL1B4ZEjxiuouvc/edit?usp=sharing"
                >
              ...
              <Card>
                <CardContent>
                  ...
                  <CardMedia
                    component={"iframe"}
                    height={300}
                    src="https://www.youtube.com/embed/Aua7F_-EMpc?si=2AzI9h4OG1LE28U5"
